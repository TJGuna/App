...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies__types_sortablejs: string;
	...
	export const npm_package_dependencies_svelte_dnd_action: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		ZDOTDIR: string;
		npm_package_devDependencies__types_sortablejs: string;
		...
		npm_package_dependencies_svelte_dnd_action: string;
		NODE_PATH: string;
